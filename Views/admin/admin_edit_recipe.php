        ...
        <article>
            <form action="?" method="POST">
                <div class="form-group col-md-6 m-auto" hidden>
                    ...
                    <input type="text" class="form-control" name="id" id="id" value="<?php echo $recipe->getId(); ?>" disabled hidden>
                </div>
                ...
                <div class="form-group col-md-6 m-auto">
                    ...
                    <input type="text" class="form-control" name="firstname" id="firstname" value="<?php echo $recipe->getFirstname(); ?>" required>
                </div>
                <div class="form-group col-md-6 m-auto">
