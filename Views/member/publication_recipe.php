...
<body class="position-relative min-vh-100 bg-light">
    ...
    <script src="https://thomaslaure.alwaysdata.net/Shlagithon/assets/js/recipe_publication.js"></script>
    <script src="https://thomaslaure.alwaysdata.net/Shlagithon/assets/js/ajax/ajax_publication_recipe.js"></script>
</body>
