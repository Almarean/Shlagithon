<footer class="mt-5 py-3 bg-light">
    <div class="container text-center">
        <div>
            ...
            <div class="mx-2 d-inline"><a href="#" class="text-dark"><i class="fab fa-instagram-square"></i></a></div>
            <div class="mx-2 d-inline"><a href="#" class="text-dark"><i class="fab fa-facebook-square"></i></a></div>
        ...
        <p><a href="mailto:mdesligues@gmail.com" class="text-dark lead"><i class="fas fa-envelope"></i> mdesligues@gmail.com</a></p>
